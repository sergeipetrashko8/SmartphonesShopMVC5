...
namespace SmartphoneStore.Domain.Concrete
{
    public class EmailSettings
    {
        ...
        public string MailFromAddress = "smartphonestore@example.com";
        ...
        public string FileLocation = @"c:\smartphone_store_emails";
    }
    ...
    public class EmailOrderProcessor : IOrderProcessor
    {
        ...
        public void ProcessOrder(Cart cart, ShippingDetails shippingInfo)
        {
            using (var smtpClient = new SmtpClient())
            {
                ...
                {
                    var subtotal = line.Smartphone.Price * line.Quantity;
                    body.AppendFormat("{0} x {1} (итого: {2:c}",
                        line.Quantity, line.Smartphone.Name, subtotal);
                }
